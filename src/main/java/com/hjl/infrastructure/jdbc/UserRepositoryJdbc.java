...
import static com.hjl.infrastructure.CacheConstants.*;
...
public class UserRepositoryJdbc implements UserRepository {
    ...
    public User findByUsername(String username) {
        final String sql = " select * from user_ where username = ? and archived = " + false;
    ...
    public List<User> findUsersByUsername(String username) {
        String sql = " select * from user_ where archived = " + false;
